...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kuka_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/catkin_ws/install/${idir}'.  Ask the maintainer 'Harsh Pandya <harsh@electricmovement.com>' to fix it.")
    endif()
