...
if("TRUE" STREQUAL "TRUE")
  set(kuka_arm_SOURCE_PREFIX /home/robond/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm)
  set(kuka_arm_DEVEL_PREFIX /home/robond/catkin_ws/devel)
  set(kuka_arm_INSTALL_PREFIX "")
  set(kuka_arm_PREFIX ${kuka_arm_DEVEL_PREFIX})
else()
  set(kuka_arm_SOURCE_PREFIX "")
  set(kuka_arm_DEVEL_PREFIX "")
  set(kuka_arm_INSTALL_PREFIX /home/robond/catkin_ws/install)
...
if(NOT "/home/robond/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kuka_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm/${idir}'.  Ask the maintainer 'Harsh Pandya <harsh@electricmovement.com>' to fix it.")
    endif()
